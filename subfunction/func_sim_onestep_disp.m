function [t_stance, X_stance, Y_stance, t_flight, Y_flight, t, X, Y, isstance] = func_sim_onestep_disp(v, alpha, theta0)
...
[t_stance, X_stance] = ode45(@func_f_disp, 0:dt:1, x0, opt_stance);
